          ...
          <div className="layout-post">
            ...
            <div className="layout-title">
              ...
              <div className="title-text">
                منشور تصميم Ui UX للتطبيقات و المواقع الالكترونية.
              </div>
            </div>
            {/* HEADER SECTION */}
            <div
              ...
              <div className="post-header">
                <div
                  disabled
                  className={`status-badge ${full ? "full" : "not-full"} `}>
                  <div className="status-badge-text">
                    {full ? "ممتلئ" : "لم يكمتل العدد"}
                  </div>
                </div>
            ...
            <img
              src="/images/5.jpg"
              alt=""
              style={{ width: "100%", height: "441.57px" }}
            />
            ...
            <div
              ...
              <div className="number-of-vol">
                العدد المطلوب: {volunteers.length}
              </div>
            </div>
            <div>
              <Grid
            ...
            <form>
              <div className="comment-publish">
                <input
                  placeholder="اضف تعليق هنا"
                  value={commentInput}
                  onChange={(e) => setCommentInput(e.target.value)}
                />
                <button
                  style={{ width: "111px", height: "52px", fontSize: "18px" }}>
                  نشر
                </button>
              </div>
            </form>
